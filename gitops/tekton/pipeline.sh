...
GIT_URL=https://github.com/wpernath/light-control-config.git
GIT_REVISION=main
GIT_USER=""
GIT_PASSWORD=""
...
IMAGE_NAME=quay.io/wpernath/light-control
IMAGE_USER=wpernath
IMAGE_PASSWORD=
TARGET_NAMESPACE=light-dev
FORCE_SETUP="false"
...
EOF
  ...
  if [[ "$FORCE_SETUP" == "true" ]]; then
    ...
    while :; do
      oc get ns/light-ci > /dev/null && break
      sleep 2
    done
  fi
